...
The original game, created by [__Mike Halsall__](https://www.mobygames.com/person/100907/mike-halsall/)
and [__John Law__](https://www.mobygames.com/person/49707/jon-law/credits/)
(with intro music by [__Bjørn Lynne__](https://lynnemusic.com)), was published in 1991 by Digital Magic Software.
This new version, which allows you to play the game on Windows, Linux, macOS and PSP platforms,
...
* [Windows binaries](https://github.com/aperture-software/colditz-escape/releases/download/v1.3/Colditz_Escape_Windows.7z "Colditz Escape (Windows).7z"), v1.3
* [Linux binaries (__x86_64__)](https://github.com/aperture-software/colditz-escape/releases/download/v1.3/Colditz_Escape_Linux.7z "Colditz Escape (Linux).7z"), v1.3
* [macOS binaries](https://github.com/aperture-software/colditz-escape/releases/download/v1.3/Colditz_Escape_MacOS.7z "Colditz Escape (OSX).7z"), v1.3
...
* [Sourcecode](https://github.com/aperture-software/colditz-escape/archive/v1.3.tar.gz), v1.3
...
* v1.3   [2025.02.19]: Drop PSP support + fix a couple of bugs with endgame conditions
